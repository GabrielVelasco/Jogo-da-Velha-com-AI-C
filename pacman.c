...
void checa(Cenario *cen, Pacman *pac, char *w){
    ...
    //verifica linha
        for(j=0,i=0; i<P; i++){
            cont = 1;
            while( ((cen->mapa[i][j] == 'x') && (cen->mapa[i][j+cont] == 'x')) || ((cen->mapa[i][j] == 'o') && (cen->mapa[i][j+cont] == 'o')) ){
                cont++;
                if(cont == 3){
                    *w = cen->mapa[i][j];
                    return;
    ...
    //verifica coluna
        for(j=0,i=0; j<P; j++){
            cont = 1;
            while( ((cen->mapa[i][j] == 'x') && (cen->mapa[i+cont][j] == 'x')) || ((cen->mapa[i][j] == 'o') && (cen->mapa[i+cont][j] == 'o')) ){
                cont++;
                if(cont == 3){
                    *w = cen->mapa[i][j];
                    return;
    ...
    //verifica diagonal principal
        for(j=0,i=0; j<1; j++){
            cont = 1;
            while( ((cen->mapa[i][j] == 'x') && (cen->mapa[i+cont][j+cont] == 'x')) || ((cen->mapa[i][j] == 'o') && (cen->mapa[i+cont][j+cont] == 'o')) ){
                cont++;
                if(cont == 3){
                    *w = cen->mapa[i][j];
                    return;
